...
namespace AIMLbot
{
    ...
    public class Bot
    {
        ...
        public string PathToAIML
        {
            get
            {
                return Path.Combine(applicationDataPath, this.GlobalSettings.grabSetting("aimldirectory"));
            }
        }
        ...
        public string PathToConfigFiles
        {
            get
            {
                return Path.Combine(applicationDataPath, this.GlobalSettings.grabSetting("configdirectory"));
            }
        }
        ...
        public string PathToLogs
        {
            get
            {
                return Path.Combine(applicationDataPath, this.GlobalSettings.grabSetting("logdirectory"));
            }
        }
        ...
        /// Ctor
        /// </summary>
        public Bot(string applicationDataPath)
        {
        ...
        public void loadSettings()
        {
            ...
            string path = Path.Combine(applicationDataPath, Path.Combine("config", "Settings.xml"));
